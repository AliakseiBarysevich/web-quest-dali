...
const answersArr = {
  1: ["7", "семь", "сем"],
  2: ["лампочка", "лампачка", "лампочька", "лампачька"],
  3: ["допущена ошибка", "дапущена ашибка", "допусчена ошибка", "допущена ашибка"],
  4: ["снег", "снек", "сьнег", "снех", "сьнех"],
...
const srcIFrameArr = ["fAmbHzB2rMA", "YBxExHJI7BM", "N6aDYbl5IN0", "tC5EJRw8V-Y", "3b-UicE8tsA", "d4XHOi6yAh0", "2o5vqMGOF8U"];
